...
compat.cfg:
Please note that, no matter what edition you have, you must also replace the compat.cfg file for High and Ultra resolution support. 3D acceleration will work without this file, but you will not be able to choose any other resolution than Normal.

experimental/:
The experimental directory, as implied by the name, is for experimental use and not intended as a final patch solution. You can nonetheless try playing around with what's in there if the official patches don't work.
